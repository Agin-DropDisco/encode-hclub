...
import ContentMultisigPolka  from "./MultisigPolka"
import "../style/slider-animations.css";
import "../style/styles.css";



const LaunchedMultisigPolka = () => {
  return (
    <div>
    <Slider className="slider-wrapper">
      {ContentMultisigPolka.map((item, index) => (
        <div key={index} className="slider-content">
            <div className="inner">
              ...
              <Card>
                ...
                <Card.Content meta={item.hds6ATss3a} />
...
export default LaunchedMultisigPolka;
